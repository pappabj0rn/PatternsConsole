namespace PatternsConsole.Structural.Bridge
{
    public class BridgeRunner : PatternRunnerBase
    {
        ...
        protected override string[] ApplicabilityLines => new[]
        {
            ...
            "both the abstractions and their implementaionts should be extensible by subclassing. In this case, the Bridge\n"+
            ...
            "(C++) you want to hide the implementation of an avstraction completely from client. In C++ the representation\n"+
            "  of a class is visible in the class interface.",
            "you have a profilation of classes as shown earlier in the first Motivation diagram. Such a class hoerarchy\n"+
            ...
            "  should be hidden from the clinet. A simple example is Coplien's String class [Cop92], in which multiple objects\n"+
            "  can share the same string representation (StringRep)."
        };
   }
}